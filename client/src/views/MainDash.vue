      ...
      <div class="main-dashboard" v-if="hydrationCheck">
        ...
        <div class="right-side-content-container">
          ...
          <div class="main-content" v-if="!loading">
            ...
            <GenSettings v-if="currentPage == 'Generator Settings'" />
          </div>
...
import GenSettings from "@/components/MainDash/GenSettings";
export default {
  name: "MainDash",
  components: {
    MainMenu,
  ...
  async created() {
    ...
    if (!this.loginData.personal_info || !this.loginData.additional_info || !this.loginData.summary || !this.loginData.education) {
